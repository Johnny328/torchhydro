...
def fusion_lstm_args():
    project_name = os.path.join("test_fusion", "exp001")
    ...
    return cmd(
        ...
        loss_func="RMSESum",
        gage_id_file=os.path.join(multi_source_origin_dir, "fusion_gage_id.csv"),
        batch_size=32,
        forecast_history=0,
        forecast_length=365,
        # rho=365,
...
def mopex_lstm_args():
    ...
    return cmd(
        ...
        loss_func="RMSESum",
        gage_id_file=os.path.join(source_origin_dir, "fusion_gage_id.csv"),
        batch_size=32,
        forecast_history=0,
        forecast_length=365,
        # rho=365,
